...
var SelectableGroup = (_temp = _class = function (_Component) {
  ...
  function SelectableGroup(props) {
    ...
    _this.clearSelection = function () {
      var selectedItemList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [].concat(_toConsumableArray(_this.selectedItems));
      var _iteratorNormalCompletion3 = true;
      var _didIteratorError3 = false;
      var _iteratorError3 = undefined;

      try {
        for (var _iterator3 = selectedItemList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      // this.props.onSelectionFinish(selectedItemList)
      _this.props.onSelectionClear(selectedItemList);
    };
  ...
  _createClass(SelectableGroup, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        var onInitialItemsSelection = _this3.props.onInitialItemsSelection;

        if (onInitialItemsSelection) {
          onInitialItemsSelection([].concat(_toConsumableArray(_this3.selectedItems)));
        }
      });
    }
  }, {
  ...
  onInitialItemsSelection: _react.PropTypes.func
}, _class.defaultProps = {
  component: 'div',
  tolerance: 0,
  globalMouse: false,
